...
if ( class_exists( 'ContusVideoController' ) != true ) {
	...
	class ContusVideoController extends ContusVideo {
		...
		function videos_data() {													## getting videos data function starts
		...
		function tag_detail( $vid ) {												## getting tag detail function starts
			return $this->get_tag_name( $vid );
		}																			## getting tag detail function ends

		function home_catthumbdata( $thumImageorder, $dataLimit ) {					##  HOME PAGE FEATURED VIDEOS STARTS
			return $this->get_home_catthumbdata( $thumImageorder, $dataLimit );
		}

		function home_thumbdata( $thumImageorder, $where, $dataLimit ) {			##  HOME PAGE FEATURED VIDEOS STARTS
			return $this->get_thumdata( $thumImageorder, $where, $dataLimit );
		}

		function countof_home_thumbdata( $thumImageorder, $where ) {				##  HOME PAGE FEATURED VIDEOS STARTS
			return $this->get_countof_thumdata( $thumImageorder, $where );
		}

		function home_playxmldata( $getVid, $thumImageorder, $where, $dataLimit ) { ##  HOME PAGE FEATURED VIDEOS STARTS
		...
		function home_playerdata() {												##  HOME PAGE player VIDEOS STARTS
			return $this->get_singlevideodata();
		}

		function home_featuredvideodata() {											##  HOME PAGE player VIDEOS STARTS
			return $this->get_featuredvideodata();
		}

		function home_featuredvideodata_banner() {									##  HOME PAGE player VIDEOS STARTS
			return $this->get_featuredvideodata_banner();
		}

		function video_detail( $vid ) {												##  HOME PAGE player VIDEOS STARTS
