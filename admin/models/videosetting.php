...
/*
  ...
  License: GPL2
 */
if ( class_exists( 'SettingsModel' ) != true ) {										## checks the SettingsModel class has been defined if starts

	class SettingsModel {															## SettingsModel class starts
		...
		public function update_settings( $settingsdata, $settingsdataformat ) {		## function for updating settings starts
		...
		public function get_settingsdata() {										## function for getting settings starts
